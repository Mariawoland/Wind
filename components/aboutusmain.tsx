...
const AboutUsMain = () => {
    return (
        <div className='sm:px-7 px-4 sm:py-16 py-12'>
            <div className='pt-7 ps-7 md:pe-0 pe-3 sm:border-t-4 border-t-2 sm:border-s-4 border-s-2 border-blue rounded-tl-2xl'>
                <p className='text-4xl font-semibold pb-4'>About us</p>
